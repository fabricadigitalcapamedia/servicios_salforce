...
export class AppComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.data = [
      {
        nameService: "MSCustomeBridgeTabCloud", curl: "curl --location 'http://mscustomebridgetabcloud-nm-salesforce-sales-dev.apps.r05oof71.eastus2.aroapp.io/MS/SVC/Service/MsCustomeBridGetabCloud/V1/Consult?tipoConsulta=1&datoBusqueda=0017800000GHJxcAAH' \
    --header 'Cookie: f46e840f28d4786aa7d60cd1c464dffd=1ef1af7a350a2046ed8cdc6c926352c0'"  , metodo: "Consult", Ambiente: "DEV"
      }
      , {
        nameService: "MSCustomeBridgeTabCloud", curl: "curl --location 'http://mscustomebridgetabcloud-nm-salesforce-sales-qa.apps.r05oof71.eastus2.aroapp.io/MS/SVC/Service/MsCustomeBridGetabCloud/V1/Consult?tipoConsulta=1&datoBusqueda=0017800000GHJxcAAH' \
    --header 'Cookie: f46e840f28d4786aa7d60cd1c464dffd=1ef1af7a350a2046ed8cdc6c926352c0'"  , metodo: "Consult", Ambiente: "QA"
      }
      , {
        nameService: "MSCustomeBridgeTableOp", curl: " curl --location 'http://mscustomebridgetableop-nm-salesforce-sales-dev.apps.claro.co/MS/CUS/CustomerAccount/RSCustomeBridgeTableOP/V1/Consult?tipoConsulta=13&datoBusqueda=12' \
    --header 'accept: application/json' \
    --header 'Content-Type: application/json' \
    --header 'Cookie: 8462980503615aa6d3733c266e4ab513=3b07e30c13a26b68abeef69eb92a5b23'"  , metodo: "Consult", Ambiente: "DEV"
      }
      , {
        nameService: "MSCustomeBridgeTableOp", curl: " curl --location 'http://mscustomebridgetableop-nm-salesforce-sales-qa.apps.claro.co/MS/CUS/CustomerAccount/RSCustomeBridgeTableOP/V1/Consult?tipoConsulta=13&datoBusqueda=12' \
    --header 'accept: application/json' \
    --header 'Content-Type: application/json' \
    --header 'Cookie: 8462980503615aa6d3733c266e4ab513=3b07e30c13a26b68abeef69eb92a5b23'"  , metodo: "Consult", Ambiente: "QA"
      }
      , {
        nameService: "MSComunicationSaleForce", curl: " curl --location 'http://mscomunicationsaleforce-nm-salesforce-sales-dev.apps.r05oof71.eastus2.aroapp.io/MS/SVC/Service/MSComunicationSaleforce/PaymentService/V1.0/getOrderPayment?identificationType=CC&identificationNumber=12345678' \
    ...
    --header 'Cookie: 170751ca5dbdd2fc7b788ea00752648c=cf5bad62ce007ecf6d953fffef89fc4d'"  , metodo: "GetOrderPayment", Ambiente: "DEV"
      }
      , {
        nameService: "MSComunicationSaleForce", curl: " curl --location 'http://mscomunicationsaleforce-nm-salesforce-sales-qa.apps.r05oof71.eastus2.aroapp.io/MS/SVC/Service/MSComunicationSaleforce/PaymentService/V1.0/getOrderPayment?identificationType=CC&identificationNumber=12345678' \
    --header 'Authorization: Bearer 00D780000008hLE!AREAQFAChMGl9_FKXmMQQi7RYmDcdBCGhWa3Nd26mTWytXFJeGX1i_oxD7KfdT6kHf2DDGqk.Ztn3Ru.sDDVQSllkvvAK3D_' \
    --header 'Cookie: 170751ca5dbdd2fc7b788ea00752648c=cf5bad62ce007ecf6d953fffef89fc4d'"  , metodo: "GetOrderPayment", Ambiente: "QA"
      }
      , {
        nameService: "MSComunicationSaleForce", curl: " curl --location 'http://mscomunicationsaleforce-nm-salesforce-sales-qa.apps.r05oof71.eastus2.aroapp.io/MS/SVC/Service/MSComunicationSaleforce/PaymentService/V1.0/VerifyOrderPayment?identificationType=CC&identificationNumber=1030588316' \
    --header 'accept: application/json' \
    --header 'Content-Type: application/json' \
    --header 'Cookie: 170751ca5dbdd2fc7b788ea00752648c=9cd1c813b3531903fbcf1203e950ec9c; 4478bc089c9d48de53802e305b954148=f974750df5a07f3d74c5b4bdab5c4f55'"  , metodo: "VerifyOrderPayment", Ambiente: "QA"
      }
      , {
        nameService: "MSComunicationSaleForce", curl: " curl --location 'http://mscomunicationsaleforce-nm-salesforce-sales-dev.apps.r05oof71.eastus2.aroapp.io/MS/SVC/Service/MSComunicationSaleforce/PaymentService/V1.0/VerifyOrderPayment?identificationType=CC&identificationNumber=1030588316' \
    --header 'accept: application/json' \
    --header 'Content-Type: application/json' \
    --header 'Cookie: 170751ca5dbdd2fc7b788ea00752648c=9cd1c813b3531903fbcf1203e950ec9c; 4478bc089c9d48de53802e305b954148=f974750df5a07f3d74c5b4bdab5c4f55'"  , metodo: "VerifyOrderPayment", Ambiente: "DEV"
      }
      , {
      ...
      , {
        nameService: "ReversePaymentSvtas",
